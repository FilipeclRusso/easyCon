...
class LiberarAcesso extends Component{
    ...
    render(){
        ...
        return(
            <View style={styles.container}>
                <Text style={styles.title}>Liberar acesso a visitantes</Text>
...
const Enviar = () => {
    ...
    const Menu = () => {
      alert('Cadastro de visitante confirmado com sucesso!');
